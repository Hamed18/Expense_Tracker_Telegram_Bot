...
A real-time, conversational financial ledger bot built with **Laravel 11**, **Telegram Bot API**, and **XAMPP (MySQL)**. This application allows users to seamlessly track incomes and expenses directly through a Telegram chat interface, rendering line-by-line chronological reports and day-by-day monthly breakdowns.
